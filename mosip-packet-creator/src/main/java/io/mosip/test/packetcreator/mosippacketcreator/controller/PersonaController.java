...
public class PersonaController {
	...
	public @ResponseBody String generateIdentityData(
		...
		try{
			...
			return packetSyncService.generateIdentityData("C:\\Work\\MOSIP\\residents\\residents_647989526968853933\\4006052100.json", contextKey).toString();
		}
		catch (Exception ex){
			logger.error("generateIdentityData", ex);
		}
		return "{Failed}";
	}
